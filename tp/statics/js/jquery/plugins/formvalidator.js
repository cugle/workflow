...
// [作者网名] 张龙	
// [邮    箱] 554024292@qq.com	
// [更新日期] 2012-01-24
// [版 本 号] ver3.3
// [修改记录] WEIGO团队修正用于JQUERY 1.4
//=============================================
...
(function($) {
    $.formValidator = {
        ...
        pageIsValid : function(validatorgroup) {
			...
			//$(initConfig.validobjectids)结果有重复
			//console.log($("#name,#passwd,#confirm_passwd"));
            jqObjs.each(function(i, elem) {
				if(typeof elem.settings=="undefined")return;
